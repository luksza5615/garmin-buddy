...
class LLMService:
    ...
    def analyze_training_period(self, activities_df: pd.DataFrame, metrics: Dict[str, Any], start_date: date, end_date: date) -> str:
        activities_data = self._format_activities_for_prompt(activities_df)
        prompt = self._build_period_analysis_prompt(activities_data, metrics, start_date, end_date)
    ...
    def _format_activities_for_prompt(self, activities_df: pd.DataFrame) -> str:
        ...
        for _, activity in activities_df.iterrows():
            activity_str = f"""
                ...
                - Elevation: +{activity['total_ascent_in_m']}m / -{activity['total_descent_in_meters']}m
    ...
    def _build_period_analysis_prompt(self, activities_data: str, metrics: Dict[str, Any], start_date: date, end_date: date) -> str:
        # TODO
